    ...
    <div class="dashboard-menu">
      <div class="dashboard-title">
        ...
        <div class="dashboard-links">
            ...
            <a href="{{route('sitegen.formbuilder.index')}}" class="dashboard-link w-button">Form Builder</a>
            <a href="{{route('sitegen.wizard.index')}}" class="dashboard-link w-button">Wizard</a>
            <a href="{{route('sitegen.setting.browse')}}" class="dashboard-link w-button">Settings</a>
        </div>
    </div>
  </div>
@endsection
